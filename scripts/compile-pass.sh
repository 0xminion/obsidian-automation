...
log "=== Starting compile pass (v2.0.1) ==="
...
if run_with_retry "Wiki compile pass (v2.0.1)" "$COMPILE_PROMPT"; then
  log "=== Compile pass completed successfully (v2.0.1) ==="
  ...
  log "=== Compile pass FAILED (v2.0.1) ==="
